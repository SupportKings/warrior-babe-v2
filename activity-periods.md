...
1) Entity Info
Entity name: client_activity_period
Display name: Activity Periods
Main field: start_date, end_date (or active)
Navigation path:
Standalone: dashboard/clients/activity-periods/:id

2) Page Header
Primary title: {client.name} - {payment_plan.name}

3) Basic Information Sections
A. Activity Period Details - editable
Fields
-client_id
-start_date
-end_date
