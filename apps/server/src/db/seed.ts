		...
		await db.insert(products).values([
			{
				...
				description:
					"Comprehensive 12-week transformation program including nutrition and fitness coaching",
			...
			},
			{
				...
				description:
					"Premium 6-month coaching package with 1-on-1 sessions and custom programming",
			...
			},
			{
				...
				description:
					"4-week intensive nutrition coaching and meal planning program",
			...
			},
			{
				...
				description:
					"8-week program focusing on mindset coaching and habit formation",
		...
		await db.insert(clients).values([
			{
				...
				onboarding_notes:
					"Motivated client, previous fitness experience, goals focused on strength training",
				overall_status: "live",
			...
			},
			{
				...
				onboarding_notes:
					"New to fitness, needs extra support with form and technique",
				overall_status: "new",
			...
			},
			{
				...
				two_week_check_in_call_completed: true,
				onboarding_notes:
					"Experienced with nutrition, needs help with workout programming",
				overall_status: "live",
			...
			},
			{
				...
				two_week_check_in_call_completed: true,
				onboarding_notes:
					"Postpartum client, cleared for exercise, focusing on core recovery",
				overall_status: "live",
			...
			},
			{
				...
				two_week_check_in_call_completed: true,
				onboarding_notes:
					"Former athlete, high motivation, interested in competition prep",
				overall_status: "live",
			...
			},
			{
				...
				two_week_check_in_call_completed: true,
				onboarding_notes:
					"Previous client returning after break, familiar with program structure",
		...
		await db.insert(clientTestimonials).values([
			{
				...
				content:
					"The Warrior Babe program completely transformed my relationship with fitness. Sarah's coaching style is incredibly motivating and she helped me build sustainable habits that I can maintain long-term.",
			...
			},
			{
				...
				content:
					"I've tried many programs before but nothing compares to the personalized attention and expertise I received here. Alex helped me break through plateaus I never thought possible.",
			...
			},
			{
				...
				testimonial_type: "Written",
				content:
					"As a former athlete, I was skeptical about online coaching, but Jessica exceeded all expectations. The program helped me regain my competitive edge while balancing my busy life.",
		...
		await db.insert(clientWins).values([
			{
				...
				description:
					"Exceeded expectations for month 1, staying consistent with nutrition and workouts",
			...
			},
			{
				...
				description:
					"Achieved major strength milestone after 6 weeks of training",
			...
			},
			{
				...
				description:
					"Successfully meal prepped for 4 weeks straight, improving nutrition consistency",
			...
			},
			{
				...
				description:
					"Safely regained core strength and overall fitness after postpartum recovery",
			...
			},
			{
				...
				description:
					"New personal record, 25 lbs increase from starting weight",
			...
			},
			{
				...
				description:
					"Overcame mental barriers around competition prep, feeling confident and motivated",
