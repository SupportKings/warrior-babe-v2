...
import SpecializationRow from "./specialization-row";
...
export function SpecializationGroup({
	category,
	specializations,
	canManage,
	onEdit,
	...
	const count = specializations.length;
								...
								<div className="flex flex-row items-center">
									<span className="min-w-0 overflow-visible text-ellipsis text-right font-[450] text-[13px] text-[lch(37.976_1_282.863)] dark:text-[lch(63.975_7_271.985)]">
										<span className="inline-flex w-auto overflow-visible tabular-nums">
											...
											&nbsp;{count === 1 ? "specialization" : "specializations"}
										</span>
									</span>
								</div>
							</div>
