...
import { createSpecialization } from "@/features/specializations/actions/createSpecialization";
...
export default function CreateSpecializationDialog({
  open,
  onOpenChange,
  onSuccess,
  ...
  const form = useForm({
    ...
    onSubmit: async ({ value }) => {
      ...
      if (result?.data?.success) {
        ...
        // Call onSuccess callback with the new specialization
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[500px]">
        ...
        <DialogDescription>
          Add a new specialization that coaches can specialize in.
        </DialogDescription>
