...
export function AddPasskeyDialog({ children, passkeyCount = 0 }: AddPasskeyDialogProps) {
    ...
    await authClient.passkey.addPasskey(
      ...
      },
      {
        ...
        onError: (error) => {
          ...
          } else if (error.error?.message?.includes("cancelled") || error.error?.message?.includes("canceled")) {
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <button
                type="button"
                className={`flex items-center justify-between p-3 rounded-lg border cursor-pointer transition-colors w-full ${
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[lch(39.286_1_282.863)] dark:text-[lch(63.975_7_271.985)]">
