  ...
  public: {
    Tables: {
      ...
      client_activity_period: {
        ...
        Relationships: [
          {
            foreignKeyName: "client_activity_period_client_id_clients_id_fk"
            columns: ["client_id"]
            isOneToOne: false
      ...
      payment_plan_templates: {
        Row: {
          created_at: string
          default_total_amount_owed: number
          id: string
          name: Database["public"]["Enums"]["payment_plan_frequency"]
      ...
      payment_plans: {
        Row: {
          ...
          type: Database["public"]["Enums"]["payment_plan_frequency"] | null
          updated_at: string
        }
        Insert: {
          client_id?: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "payment_plans_client_id_clients_id_fk"
            columns: ["client_id"]
            isOneToOne: false
            referencedRelation: "clients"
            referencedColumns: ["id"]
