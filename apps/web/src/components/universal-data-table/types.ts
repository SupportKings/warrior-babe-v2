...
export interface UniversalTableConfig<T extends UniversalTableRow = UniversalTableRow> {
...
export interface OptionColumnBuilder<T> extends BaseColumnBuilder<T, 'option'> {}
export interface MultiOptionColumnBuilder<T> extends BaseColumnBuilder<T, 'multiOption'> {}
export interface RelationColumnBuilder<T> extends BaseColumnBuilder<T, 'option'> {
