...
Main field: name or description
Navigation path:
Standalone: dashboard/system-config/products/:id

2) Page Header
Primary title: {product.name} - {product.is_active}

3) Basic Information Sections
A. Product Details - editable
Fields
-Details
name
description
...
4) Payment Plan Templates (ability to create) table use universal table

- payment_plan_templates.name

- payment_plan_templates.min_total_amount_owed

5) System Information (Auto-appended)
